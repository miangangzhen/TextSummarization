...
class WordEmbeddingInitializer(Initializer):
    ...
    def __call__(self, shape, dtype=None, partition_info=None):
        ...
        if self.path != WordEmbeddingInitializer.currentpath:
            ...
            WordEmbeddingInitializer.currentdata = npdata
            WordEmbeddingInitializer.currentpath = self.path
            return WordEmbeddingInitializer.currentdata
