...
class ProjectionLayer(tf.layers.Layer):
    ...
    def call(self, inputs, **kwargs):
        ...
        if self.params.pointer_gen:
            ...
            final_dists = self._calc_final_dist(vocab_dists, inputs["attn_dists"], inputs["p_gens"], max_art_oovs)
    ...
    def _calc_final_dist(self, vocab_dists, attn_dists, p_gens, max_art_oovs):
        """Calculate the final distribution, for the pointer-generator model

        Args:
          vocab_dists: The vocabulary distributions. List length max_dec_steps of (batch_size, vsize) arrays. The words are in the order they appear in the vocabulary file.
          attn_dists: The attention distributions. List length max_dec_steps of (batch_size, attn_len) arrays. attn_len =? enc_sequence_length
